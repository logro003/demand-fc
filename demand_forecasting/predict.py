...
def predict(inference_with_features_df: pd.DataFrame, features:list, model)->pd.DataFrame:
    ...
    inference_with_features_df['predicted_num_of_rides'] = round(inference_with_features_df.predictions, 0)
    ...
    predicitons_output_df = inference_with_features_df[['h3index_small', 'date', 'predicted_num_of_rides']]
