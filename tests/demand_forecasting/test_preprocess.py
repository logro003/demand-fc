...
def test_len_of_df():
    """ Testing lengt of preprocessed dataframe """
    # Given
...
def test_number_of_rides():
    """ Testing the aggregating of number of rides """
    # Given
    rides_df, weather_df = generate_mock_data()
    # When
    df_preprocessed = preprocessing(rides_df, weather_df)
...
def generate_mock_data():
    ...
    rides_df = pd.DataFrame(
        {
            ...
            "start_time": [
                pd.to_datetime("2020-08-05 04:27:40.425797 UTC"),
                pd.to_datetime("2020-08-06 07:47:29.060615 UTC"),
            ],
    ...
    weather_df = pd.DataFrame(
        {
            "date": [pd.to_datetime("2020-08-05"), pd.to_datetime("2020-08-06")],
